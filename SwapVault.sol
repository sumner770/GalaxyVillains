...
contract SwapVault is Ownable, ReentrancyGuard, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        // Initialize Fees
        treasuryFee = 200; // bips
        devFee = 200; // bips
        liquidityFee = 100; // bips
    ...
    function _swapAndSendDividendsAndLiquidity(uint256 amount) private {
        ...
        // Liquify Tokens.
        if (liquidityFee > 0 && tokensForLiquify > 0) {
    ...
    function _swapTokensForEth(uint256 amount) private {
        ...
        uniswapV2Router.swapExactTokensForETH(
            amount,
            1, // accept any amount of ETH... unlimited slippage
            path,
            address(this),
            block.timestamp
        );
    ...
    function performUpkeep(
        ...
        if (_shouldSendBatch()) {
            _swapAndSendDividendsAndLiquidity(swapTokensAtAmount);
            _maintainLinkBalance();
        }
    }
